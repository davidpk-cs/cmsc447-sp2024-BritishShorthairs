...
var assetsPath = "url(\"{{ url_for('static', filename='assets/"
var assetsEnd = "') }}\")"
...
function sendEnemyWave(){
    ...
    for(var i = 0; i < enemyCount; i++){
        ...
        newRock.src = assetsPath + 'enemies/tile007.png' + assetsEnd; // Set the source to the PNG sprite
...
function placeTower(){
    ...
    document.getElementById('viewPort').addEventListener('click', function(event) {
        ...
        newTower.src = assetsPath + "enemies/ufoBlue.png" + assetsEnd; // Setting the source of the image
